...
export function Sidebar({ currentView, setCurrentView, openPasswordModal, userRole }: SidebarProps) {
  ...
  const NavItem = ({ view, icon: Icon, label }: { view: View; icon: any; label: string }) => (
    <button
      ...
      className={`w-full flex flex-col items-center justify-center py-4 transition-colors relative group cursor-pointer
    ...
    <div className="w-[93px] bg-[#0a0da4] flex flex-col items-center py-4 z-50 shadow-xl shrink-0 h-screen sticky top-0">
      ...
      <div className="flex-1 w-full space-y-2 flex flex-col items-center">
        ...
        <div className="relative w-full">
          <button
            ...
            className={`w-full flex flex-col items-center justify-center py-4 transition-colors cursor-pointer
      ...
      <div className="mt-auto w-full">
         ...
         <button
          ...
          className="w-full flex flex-col items-center justify-center py-4 text-slate-300 hover:text-white hover:bg-white/5 transition-colors cursor-pointer"
          title="Logout"
        >
