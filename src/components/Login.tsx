...
export function Login({ onLogin, onNavigateToRegister, onForgotPassword }: LoginProps) {
           ...
           <form onSubmit={handleSubmit}>
             ...
             <div className="absolute left-[48px] top-[390px] w-[476px] flex justify-between items-center">
               ...
               <button 
                 ...
                 className="text-[#00b2ff] text-[14px] font-medium cursor-pointer"
               >
                 Forgot Password?
               </button>
             </div>
             ...
             <button 
               type="submit"
               className="absolute left-[48px] top-[448px] w-[476px] h-[52px] rounded-[10px] bg-gradient-to-r from-[#0d79a7] to-[#09b5ff] text-white text-[20px] font-semibold hover:opacity-90 transition-opacity cursor-pointer"
             >
               Log in
             </button>
             ...
             <div className="absolute left-[48px] top-[557px] w-[476px] flex justify-center items-center gap-1 text-[15px]">
               ...
               <button type="button" onClick={onNavigateToRegister} className="text-[#1a51de] cursor-pointer">
                 Create Account
               </button>
             </div>
           </form>
